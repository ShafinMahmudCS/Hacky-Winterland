...
const trackStockArrival = (e) => {
  ...
  document.getElementById("stockOutput").innerHTML = "Success!" + "</br>" + "If the stock arrives, you will receive an email."
};
...
const trackPriceReduction = (e) => {
  ...
  document.getElementById("priceOutput").innerHTML = "Success!" + "</br>" + "If the price reduces you will receive an email.";
};
...
document.addEventListener("DOMContentLoaded", () => {
  chrome.tabs.getSelected(null, async (tab) => {
    ...
    if (url.startsWith("https://www.amazon.")) {
      ...
      console.log(date);
      document.getElementById("history1").innerHTML = "<em>" + "<u>" + "First data: " + "</u>" + "</em>" + "</br>" +"Date: " + new Date(price_trend[0].x*1000) + "</br>" + "Price: " + price_trend[0].y/100;
      document.getElementById("history2").innerHTML = "<em>" + "<u>" + "Second data: " + "</u>" + "</em>" + "</br>" +"Date: " + new Date(price_trend[1].x*1000) + "</br>" + "Price: " + price_trend[1].y/100;
      document.getElementById("history3").innerHTML = "<em>" + "<u>" + "Third data: " + "</u>" + "</em>" + "</br>" +"Date: " + new Date(price_trend[2].x*1000) + "</br>" + "Price: " + price_trend[2].y/100;
      document.getElementById("history4").innerHTML = "<em>" + "<u>" + "Fourth data: " + "</u>" + "</em>" + "</br>" +"Date: " + new Date(price_trend[3].x*1000) + "</br>" + "Price: " + price_trend[3].y/100;
